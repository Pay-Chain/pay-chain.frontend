<script lang="ts">
  ...
  function calculateFees() {
    if (!amount) {
      feePreview = { platformFee: '0', bridgeFee: '0', totalFee: '0', estimatedReceived: '0' };
      return;
    }
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      goto(`/payments/${result.data?.paymentId}`);
    } catch (e: any) {
...
<svelte:head>
  <title>New Payment - Pay-Chain</title>
</svelte:head>
...
<div class="bg-gray-950 min-h-screen">
  <div class="mx-auto max-w-2xl px-4 py-8 sm:px-6 lg:px-8">
    <!-- Header -->
    <div class="mb-8">
      <a href="/payments" class="text-gray-400 hover:text-white text-sm mb-2 inline-block">
        ← Back to Payments
      </a>
    ...
    {:else}
      <form on:submit|preventDefault={handleSubmit} class="space-y-6">
        ...
        <div class="card bg-gray-900 border-gray-800">
          ...
          <div class="mt-4">
            <label class="block text-sm text-gray-300 mb-2">Receiver Address</label>
            <input
              type="text"
        ...
        <div class="card bg-gray-900 border-gray-800">
          ...
          <div class="space-y-2 text-sm">
            ...
            <div class="flex justify-between">
              ...
              <span class="text-green-400 font-medium">${feePreview.estimatedReceived}</span>
            </div>
          </div>
        </div>
