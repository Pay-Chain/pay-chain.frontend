...
export interface Dictionary {
  ...
  settings: {
    ...
    api_keys: {
      ...
      modal: {
        ...
        warning_copy_credentials: string;
        copied: string;
  ...
  merchant_settings_view: {
    ...
    webhook: {
      ...
      description: string;
      test_ping: string;
      payload_destination: string;
      payload_placeholder: string;
      payload_destination_help: string;
      active_traffic_title: string;
      active_traffic_desc: string;
    ...
    api_keys: {
      ...
      revoked_success: string;
      revoked_failed: string;
      create_failed: string;
      modal_created_title: string;
      modal_create_title: string;
      modal_secret_warning: string;
      modal_close: string;
      modal_generate: string;
      key_name: string;
      key_name_placeholder: string;
    };
    delivery_history: {
    ...
    settlement: {
      ...
      token_group: string;
      destination_chain: string;
      destination_chain_placeholder: string;
      destination_token: string;
      destination_token_placeholder: string;
      destination_token_select_chain_first: string;
      destination_wallet: string;
      destination_wallet_placeholder: string;
      help_title: string;
      help_token: string;
      help_wallet: string;
      help_defaults_label: string;
      help_defaults: string;
      connected_wallets: string;
      manage_wallets: string;
      no_wallets: string;
      use_wallet: string;
  ...
  docs: {
    ...
    home: {
      ...
      feature: {
        'Cross-Chain Runtime': string;
        'Secure By Default': string;
        'Operator Ready': string;
        'Token-Native Flows': string;
      };
      feature_desc: {
        'Cross-Chain Runtime': string;
        'Secure By Default': string;
    ...
    api: {
      ...
      create_flow_title: string;
      create_flow_desc: string;
      create_flow_badge: string;
      create_flow_step1_title: string;
      create_flow_step1_desc: string;
      create_flow_step2_title: string;
      create_flow_step2_desc: string;
      create_flow_step3_title: string;
      create_flow_step3_desc: string;
      ...
      endpoint_create_payment_desc: string;
      endpoint_partner_quotes_desc: string;
      endpoint_partner_session_create_desc: string;
      endpoint_partner_session_read_desc: string;
      endpoint_partner_resolve_desc: string;
      endpoint_legacy_payment_requests_desc: string;
      endpoint_legacy_pay_read_desc: string;
      endpoint_legacy_resolve_desc: string;
      try_title: string;
      try_cta: string;
      try_cta_loading: string;
      try_cta_success: string;
      try_cta_error: string;
      path_override_hint: string;
      errors_title: string;
      errors_desc: string;
    };
    guides: {
      ...
      resource_api_title: string;
      resource_api_desc: string;
      resource_community_title: string;
      resource_community_desc: string;
      resource_support_title: string;
      resource_support_desc: string;
      resource_partner_title: string;
      resource_partner_desc: string;
    };
    partner: {
      title: string;
      subtitle: string;
      ...
      hmac_title: string;
      hmac_desc: string;
      endpoint_map_title: string;
      create_quote_title: string;
      create_payment_title: string;
      session_read_resolve_title: string;
      webhooks_title: string;
      webhooks_desc: string;
      retry_desc: string;
      legacy_notice_desc: string;
      endpoint_quotes_desc: string;
      endpoint_create_payment_desc: string;
      endpoint_sessions_desc: string;
      endpoint_read_desc: string;
      ...
      same_chain_title: string;
      same_chain_desc: string;
