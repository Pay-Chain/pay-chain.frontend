      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {isChainsLoading ? (
          ...
          <div className="col-span-full text-center py-20 border border-white/10 rounded-3xl bg-white/5 backdrop-blur-md">
            ...
            <h3 className="text-lg font-bold text-foreground">No chains found</h3>
            <p className="text-muted text-sm max-w-xs mx-auto mt-1">Try adjusting your search terms.</p>
          </div>
        ) : (
          <>
