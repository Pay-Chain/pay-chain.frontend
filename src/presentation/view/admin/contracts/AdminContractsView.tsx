...
const metadataPlaceholderByType: Record<string, string> = {
  ...
  HYPERBRIDGE_TOKEN_GATEWAY: '{"teleporter":"0x...","assetId":"0x..."}',
  ADAPTER_HYPERBRIDGE_TOKEN_SENDER: '{"tokenGateway":"0x...","gateway":"0x...","router":"0x..."}',
  ADAPTER_HYPERBRIDGE_TOKEN_RECEIVER: '{"tokenGateway":"0x...","swapper":"0x...","gateway":"0x..."}',
  ADAPTER_STARGATE: '{"endpoint":"0x...","dstEid":"...","peer":"0x..."}',
  PRIVACY_MODULE: '{"authorizedGateway":"0x..."}',
  STEALTH_ESCROW_FACTORY: '{"privacyModule":"0x..."}',
  FEE_POLICY_MANAGER: '{"defaultStrategy":"0x..."}',
  FEE_STRATEGY_DEFAULT_V1: '{"tokenRegistry":"0x..."}',
...
export const AdminContractsView = () => {
  ...
  const CONTRACT_TYPES = [
    ...
    { value: 'HYPERBRIDGE_TOKEN_GATEWAY', label: 'Hyperbridge Token Gateway' },
    { value: 'ADAPTER_HYPERBRIDGE_TOKEN_SENDER', label: 'Adapter Hyperbridge Token Sender' },
    { value: 'ADAPTER_HYPERBRIDGE_TOKEN_RECEIVER', label: 'Adapter Hyperbridge Token Receiver' },
    { value: 'ADAPTER_STARGATE', label: t('admin.contracts_view.contract_types.adapter_stargate') },
    { value: 'PRIVACY_MODULE', label: t('admin.contracts_view.contract_types.privacy_module') },
    { value: 'STEALTH_ESCROW_FACTORY', label: t('admin.contracts_view.contract_types.stealth_escrow_factory') },
    { value: 'FEE_POLICY_MANAGER', label: t('admin.contracts_view.contract_types.fee_policy_manager') },
    { value: 'FEE_STRATEGY_DEFAULT_V1', label: t('admin.contracts_view.contract_types.fee_strategy_default_v1') },
